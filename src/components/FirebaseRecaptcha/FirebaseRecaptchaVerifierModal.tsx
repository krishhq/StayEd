...
import { StyleSheet, Button, View, SafeAreaView, Text, Modal, ActivityIndicator, ViewStyle, StyleProp } from 'react-native';
import FirebaseRecaptcha, { FirebaseRecaptchaProps } from './FirebaseRecaptcha';

interface Props extends Omit<FirebaseRecaptchaProps, 'onVerify' | 'onLoad' | 'onError' | 'onFullChallenge'> {
    title?: string;
    cancelLabel?: string;
